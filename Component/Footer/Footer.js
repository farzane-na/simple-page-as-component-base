...
template.innerHTML = `
    ...
    <div class="container">
        ...
        <div class="social-media">
            ...
            <a href="{{ site.baseurl }}/index.html"><i class="fa fa-instagram icons"></i></a>
            <a href="{{ site.baseurl }}/index.html"><i class="fa fa-telegram icons"></i></a>
            <a href="{{ site.baseurl }}/index.html"><i class="fa fa-linkedin icons"></i></a>
            <a href="{{ site.baseurl }}/index.html"><i class="fa fa-facebook-f icons"></i></a>
        </div>
    </div>
`
