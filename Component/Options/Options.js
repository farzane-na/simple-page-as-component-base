...
`
    ...
    <div class="options option1">
        <div class="options__image">
            <img src="https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-92090.jpg" alt="">
        </div>
...
`
    ...
    <div class="options option2">
        <div class="options__image">
            <img src="https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-91829.jpg" alt="">
        </div>
...
`
    ...
    <div class="options option3">
        <div class="options__image">
            <img src="https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-91966.jpg" alt="">
        </div>
        <div class="options__caption">
...
`
    ...
    <div class="options option4">
        <div class="options__image">
            <img src="https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-91974.png" alt="">
        </div>
        <div class="options__caption">
...
`
    ...
    <div class="options option5">
        <div class="options__image">
            <img src="https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-91976.jpg" alt="">
        </div>
        <div class="options__caption">
...
`
    ...
    <div class="options option6">
        <div class="options__image">
            <img src="https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-91833.jpg" alt="">
        </div>
        <div class="options__caption">
